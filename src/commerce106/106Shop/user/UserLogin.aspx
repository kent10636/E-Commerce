    ...
    <form id="form1" runat="server">
        <div class="main">
            <div class="top" style="background-color: #F73809">
                ...
                <div class="topright">
                    ...
                    <asp:LinkButton ID="linkReset" runat="server" CausesValidation="False"
                        OnClick="linkReset_Click">退出</asp:LinkButton>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="logincontentdenglu">
                <div class="logincontentleft" style="margin: 0 auto;">
                    ...
                    <div class="loginleftbtneir">
                        ...
                        <div class="loginleftbtneircount">
                            ...
                            <div class="logindenglu">
                                <ul>
                                    ...
                                    <li>
                                        <img src="../Tool/CheckInage.aspx" onclick="this.src=this.src+'?'" alt="陇原商城" id="imgcode" title="点击刷新验证码" style="vertical-align: middle; cursor: pointer; margin: 0px; padding: 0px;" /></li>
                                </ul>
                            </div>
                            <div class="logindenglu">
                                <ul>
                            ...
                            <div class="logindenglu1">
                                <div class="logindengluuser">
                                    <asp:ImageButton ID="ibtnlogin" runat="server"
                                        ImageUrl="~/images/userlogin.jpg" AlternateText="用户登录"
                                        OnClick="ibtnlogin_Click" Height="33px" Width="100px" />
                                </div>
                                <div class="logindengluuser1"><a href="UserRegister.aspx" title="会员注册">
                                    <img src="../images/userregister.jpg" alt="会员注册" style="height: 33px; width: 107px" /></a></div>
                            </div>
                        ...
                        <div class="loginlefttop">
                            <img src="../images/logo51.gif" alt="会员注册" /></div>
                    </div>
                </div>
