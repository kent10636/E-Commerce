...
<div style="background-image:url(../images/topbg.gif);">
    <img src="../images/xdlogo.png" title="系统首页" />
</div>
...
<div style="height:32px; width:1000px; background-color:#F1F1F1" onload="show()"> 
    <ul class="smenu">
        <li style="padding-left:-100px; float:left;" id="s_1" class='s_li_a'>欢迎登录网上商城后台系统，系统当前的时间是：<asp:Label ID="lblTime" runat="server" ForeColor="Red"></asp:Label>
            <asp:LinkButton ID="linkreset" runat="server" 
            OnClientClick="return confirm('您确定要返回登录页吗？')" Font-Underline="False" ForeColor="Blue">返回</asp:LinkButton>
        </li>
