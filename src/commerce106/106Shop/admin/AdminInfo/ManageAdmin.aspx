...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <table align="right" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td align="center"
                    style="background-color: #C0C0C0; font-size: 22px; font-weight: bold;">查看管理员信息</td>
            </tr>
            <tr>
                <td>
                    <asp:GridView ID="gvmanagerAdmin" runat="server" BackColor="#DEBA84"
                        ...
                        <Columns>
                            <asp:BoundField DataField="AdminID" HeaderText="管理员ID" ReadOnly="True" />
                            ...
                            <asp:TemplateField HeaderText="删除管理员">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Delete" OnClientClick="return confirm('您确认删除该管理员吗？')" CausesValidation="False" ToolTip="删除"><img src="../images/cancel.png" alt="修改" width="20px" height="20px" /></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="管理员管理">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnSetRole" runat="server" CommandName="Update" Text='<%#(System.Int16) DataBinder.Eval(Container.DataItem,"IsEnabled")==1?"禁用管理员":"起用管理员" %>' CommandArgument='<%# DataBinder.Eval(Container.DataItem,"AdminID") %>'>'</asp:LinkButton>
                                </ItemTemplate>
