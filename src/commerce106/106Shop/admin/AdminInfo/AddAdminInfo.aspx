        ...
        <table align="left" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td colspan="3" align="center"
                    style="background-color: #C0C0C0; font-size: 22px; font-weight: bold;">添加管理员</td>
            </tr>
            <tr>
                <td style="width: 15%; height: 36px;" align="right">
                    <span style="color: Red">*</span>管理员名称：</td>
            ...
            <tr>
                <td align="right" style="height: 36px;">
                    <span style="color: Red">*</span>确&nbsp;认&nbsp;密&nbsp;码：</td>
                <td align="left" style="height: 36px" colspan="2">
            ...
            <tr>
                <td align="right" style="height: 36px;">
                    <span style="color: Red">*</span>管理员类型：</td>
                <td align="left" colspan="2">
