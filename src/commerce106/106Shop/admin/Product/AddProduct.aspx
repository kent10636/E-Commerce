    ...
    <div>
        ...
        <div>
            <table align="center" cellpadding="0" cellspacing="0" style="width: 820px; border: 1px solid red">
                ...
                <tr>
                    <td style="width: 20%; height: 30px" align="right">产品型号：</td>
                ...
                <tr>
                    <td align="right" style="height: 30px">产品名称：</td>
                    <td align="left">
                ...
                <tr>
                    <td align="right" style="height: 30px">商品类别：</td>
                    <td align="left">
                ...
                <tr>
                    <td align="right" style="height: 30px">产品图片：</td>
                    <td align="left">
                ...
                <tr>
                    <td align="right" style="height: 30px">商品原价：</td>
                    <td align="left">
                ...
                <tr>
                    <td align="right" style="height: 30px">商品现价：</td>
                    <td align="left">
                ...
                <tr>
                    <td align="right" style="height: 30px">会员现价：</td>
                    <td align="left">
                ...
                <tr>
                    <td align="right" style="height: 30px">供应总数：</td>
                    <td align="left">
                ...
                <tr>
                    <td align="right" style="height: 30px">单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：</td>
                ...
                <tr>
                    <td align="right" style="height: 30px">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;费：</td>
                    <td align="left">
                        ...
                        <asp:TextBox ID="txtFreight" runat="server" Width="100px" MaxLength="10" Text="10"
                            BorderColor="Black" BorderWidth="1px"></asp:TextBox>元
                        <span>
                ...
                <tr>
                    <td align="right" style="height: 30px">客&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 服：</td>
                    <td align="left">
                ...
                <tr>
                    <td align="right" style="height: 30px">允许评论：</td>
                ...
                <tr>
                    <td align="right" style="height: 30px">有 效 期 ：</td>
                    <td align="left">
                ...
                <tr>
                    ...
                    <td align="center" style="height: 49px">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnUpdate" runat="server"
                            OnClick="btnUpdate_Click" Text="修改商品" />
                        &nbsp;&nbsp;
