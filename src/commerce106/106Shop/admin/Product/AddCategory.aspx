        ...
        <div id="Div1" style="margin-left: 20px; margin-top: 20px;" runat="server">
            <div style="height: 127px; width: 360px;">
                <table align="left" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="right" style="width: 35%; height: 40px;">分类名称：</td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="right" style="height: 40px;">所属分类：</td>
                        <td align="left">
            ...
            <div style="width: 214px; float: left">
                <table style="border: 1px solid #99FFCC">
            ...
            <div id="editDiv" style="position: absolute; width: 214px; height: 152px; padding: 5px; display: none;">
                ...
                <input id="olddepth" runat="server" style="width: 24px" type="hidden" />
            </div>
        </div>
