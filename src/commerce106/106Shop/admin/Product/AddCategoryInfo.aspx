        ...
        <table align="center" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td colspan="3" align="center"
                    style="background-color: #C0C0C0; font-size: 22px; font-weight: bold;">管理商品分类信息</td>
            </tr>
            <tr>
                <td>
                    <iframe id="category" name="category" src="AddCategory.aspx" width="420px" height="700px" frameborder="0" scrolling="no"></iframe>
                </td>
            </tr>
        </table>
