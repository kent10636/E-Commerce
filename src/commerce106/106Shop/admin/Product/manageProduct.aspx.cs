...
public partial class admin_Product_manageProduct : System.Web.UI.Page
{
    ...
    protected void btnIsPost_Click(object sender, EventArgs e)
    {
        ...
        if (new TableUpDateFieldsInfo().UpdateShoping("product", "isPost=1", " and isPost=0 and productID in(" + str + ")") > 0)
        {
    ...
    protected void btnNotIsPost_Click(object sender, EventArgs e)
    {
        ...
        if (new TableUpDateFieldsInfo().UpdateShoping("product", "isPost=0", " and isPost=1 and productID in(" + str + ")") > 0)
        {
            Page.ClientScript.RegisterStartupScript(this.GetType(), "", WebUnitily.AlertUrl("您的产品上架成功！"));
        }
        else
    ...
    protected void btnIsCommend_Click(object sender, EventArgs e)
    {
        ...
        if (new TableUpDateFieldsInfo().UpdateShoping("product", "isCommend=1", " and isPost=1 and productID in(" + str + ")") > 0)
        {
    ...
    protected void btnCanceltuijian_Click(object sender, EventArgs e)
    {
        ...
        if (new TableUpDateFieldsInfo().UpdateShoping("product", "isCommend=0", " and isPost=1 and productID in(" + str + ")") > 0)
        {
